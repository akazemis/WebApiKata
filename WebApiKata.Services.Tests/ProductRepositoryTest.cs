    ...
    public class ProductServiceTest
    {
        ...
        public static IEnumerable<object[]> GetSortByPriceAscendingInputAndExpectedOutputList()
        {
            ...
            yield return new object[]
            {
                ...
                new List<Product>()
                {
                    GetProduct("product1", 2.0m, 1),
                    GetProduct("product2", 1.0m, 3),
                    GetProduct("product3", 1.2m, 2)
                },
                // Expected Output
                new List<Product>()
                {
        ...
        private static Product GetProduct(string name, decimal price, decimal quantity)
        {
            return new Product()
            {
                Name = name,
